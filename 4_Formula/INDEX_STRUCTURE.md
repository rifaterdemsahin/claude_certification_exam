...
## Testing
A test suite is provided in `/7_Testing_Known/` directory:
...
- `7_Testing_Known/`: Test suite for verification
- `5_Symbols/pages/`: Auxiliary HTML pages (dictionary, mindmap, etc.)
- `5_Symbols/assets/`: Images and SVG graphics
- `5_Symbols/data/`: Raw question data (JSON)
- `5_Symbols/docs/`: Study documentation by competency
- `4_Formula/`: Concept explanations and memory aids
