...
try {
    ...
    console.log("✓ PASS: Filenames and Azure URLs match expected types (.png for 1-58, .svg for others).");
    ...
    console.log("✓ PASS: Local PNG files for questions 1 to 58 (excluding 43) exist on disk.");
